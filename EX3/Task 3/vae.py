...
class VariationalEncoder(nn.Module):
    ...
    def __init__(self, latent_dims):
        ...
        self.linearMean = nn.Linear(256, latent_dims)
        self.linearStd = nn.Linear(256, latent_dims)
...
class Decoder(nn.Module):
    ...
    Args:
        std_dev: Implement the standard deviation for the decoder distribution as one.
    ...
    def __init__(self, latent_dims):
        ...
        self.linear2 = nn.Linear(256, 256)
        self.linearMean = nn.Linear(256, 784)
