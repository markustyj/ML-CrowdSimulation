...
public abstract class SimulationModel<T extends DefaultSimulationConfig> extends DefaultModel {
	...
	// define colors for three different groups
	// red for infective, yellow for susceptible and blue for recovered
	protected final Color infectiveColor = new Color(255, 0, 0);
	protected final Color susceptibleColor = new Color(255, 255, 0);
	protected final Color recoveredColor = new Color(0, 0, 255);
	...
	public SimulationModel(final T config) {
		super(config);
		this.config = config;
		// change the default simulator coloring agent
		...
		// map group id to the corresponding group color
	...
	public Color getRecoveredColor() { return recoveredColor; 	} //Retrieval the value of recover color and return
